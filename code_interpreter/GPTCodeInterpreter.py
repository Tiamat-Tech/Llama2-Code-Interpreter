...
extra_prompt = """
###User : what's the wheter in seoul?
...
# Find the element with the temperature. The element's class or id may vary.
# This is just an example and may not work, as Google's page structures can change frequently.
temp_element = soup.find('div', attrs={'class': 'BNeawe iBp4i AP7Wnd'}).text
print(temp_element)
...
24
```
It's 24 celsius in Seoul.
------
Like this You can aceess web by generation of code. You may use code to answer the question. code generated by you will automatically executed.
"""
